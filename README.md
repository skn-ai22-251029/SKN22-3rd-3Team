...
## 5. 결과물 예시 (Output Example)
파이프라인 단계별 또는 최종 DB에 적재되는 데이터의 구조 예시입니다.

### **[V3 Processed Data Sample]**
`data/v3/processed.json` 및 MongoDB `cat_library` 컬렉션에 저장되는 표준 규격입니다.
```json
{
  "uid": "v3_00000",
  "title_refined": "고양이 췌장염 관리 수칙",
  "summary": "고양이 췌장염 예방을 위한 보호자의 관리 수칙을 안내합니다.",
  "keywords": ["고양이", "췌장염", "관리", "예방"],
  "intent_tags": ["Health Alert", "Pro Tip"],
  "categories": ["Health", "Care"],
  "specialists": ["Physician"],
  "text": "고양이의 췌장염은 단순히 한 번의 치료로 끝나는 질환이 아닙니다...",
  "tokenized_text": "고양이 췌장염 관리 수칙 고양이 췌장염 예방 위하...",
  "embedding": [0.0023, -0.0142, ...] // Vector Search용 벡터 (1536 dim)
}
```
